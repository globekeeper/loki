...
# Configures memberlist
[memberlist: <memberlist_config>]

# Configures tracing in Loki
...
storage:
  ...
  # Configures Azure Blob Storage as common storage
...
Configures Azure Blob Storage as common storage The supported CLI flags `<prefix>` used to reference this config block are:
...
Configures GCS as the common storage The supported CLI flags `<prefix>` used to reference this config block are:
...
# CLI flag: -ruler.storage.gcs.enable-http2
...
Configures Swift as the common storage The supported CLI flags `<prefix>` used to reference this config block are:
