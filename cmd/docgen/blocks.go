...
var (
	rootBlocks = []rootBlock{
		...
		},
		{
			...
			desc:       "Configures memberlist",
		},
		{
			name:       "tracing_config",
			structType: reflect.TypeOf(tracing.Config{}),
			desc:       "Configures tracing in Loki",
		},
		{
